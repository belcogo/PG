...
const float SLICE = 2 * M_PI / (float) 60;
const float THREE_COMPLETE_CIRCLES = 3.0f * 2.0f * M_PI;
const float RADIUS_INCREMENT = 0.5f;
const float ANGLE_INCREASE = THREE_COMPLETE_CIRCLES / (float)(NUM_POINTS - 2);
const float RADIUS_INCREASE = RADIUS_INCREMENT / (float) (NUM_POINTS - 2);
